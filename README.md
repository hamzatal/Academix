...
![Academ IX admin-hero](/public/github-images/admin-hero.png)
![Academ IX admin-user](/public/github-images/admin-user.png)
![Academ IX admin-message](/public/github-images/admin-message.png)
![Academ IX admin-package](/public/github-images/admin-package.png)
...
![Academ IX admin-profile](/public/github-images/admin-profile.png)
...
![Homepage](https://via.placeholder.com/800x400/E5E7EB/374151?text=Travel++Homepage)
...
```bash
git clone https://github.com/travel-/travel-.git
cd travel-
```
...
```bash
# Create database
mysql -u root -p -e "CREATE DATABASE travel__test;"

# Import sample data
mysql -u root -p travel__test < database/travel__test.sql
...
-   🗺️ **Destination Management**: Create and edit Academ IXdestinations
-   📦 **Package Creation**: Design complete Academ IXpackages
