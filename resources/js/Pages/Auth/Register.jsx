                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-400 text-center mt-2">
                                    For personal Academ IXand experiences
                                </p>
                            </div>
                            <div
                                className={`p-6 rounded-lg border-2 cursor-pointer transition-all flex flex-col items-center
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-400 text-center mt-2">
                                    For managing Academ IXservices and listings
                                </p>
                            </div>
                        </div>
                        {errors.role && (
            ...
            <div className="hidden lg:flex w-1/2 items-center justify-center p-12">
                <div className="text-center space-y-8">
                    ...
                    <h1 className="text-5xl font-bold text-white">
                        Join <span className="text-green-500">Academ IX</span>
                    </h1>
                    <p className="text-gray-300 max-w-md mx-auto text-lg">
                        {accountType === "company"
                            ? "Create a company account to list your Academ IXservices, packages, and destinations."
