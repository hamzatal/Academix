...
export default function Register() {
    ...
    return (
        <div className="relative min-h-screen flex">
            ...
            {/* Main Content */}
            <div
                className={`relative z-10 flex w-full transition-colors duration-300 ${
            ...
            >
                ...
                <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-center p-12">
                    ...
                    >
                        Join our community of movie enthusiasts. Create your
                        account to access unlimited movies, personalized
