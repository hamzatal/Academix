            ...
            >
                ...
                <div className="p-4 flex flex-col flex-grow">
                    <div className="mb-2">
                        ...
                        >
                            {destination.company_name || "Academ IX"}
                        </p>
                        <div className="flex items-center gap-2 mt-1">
                            <MapPin
                                size={14}
...
const HomePage = ({ auth, favorites: initialFavorites = [] }) => {
    ...
    return (
        ...
        >
            <Head>
                <title>Academ IX - Your Adventure Awaits</title>
                <meta
                    name="description"
                    content="Discover unforgettable trips, explore stunning destinations, and book the best Academ IXdeals with Academ IX."
                />
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                aria-label="Get random Academ IXsuggestions"
                            >
                                <Sparkles size={20} />
