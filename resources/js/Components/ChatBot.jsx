...
const ChatBot = () => {
    ...
    const [messages, setMessages] = useState([
        {
            text: "مرحبًا بك في Travel AI! أنا هنا لتخطيط رحلتك المثالية. أخبرني عن خطط سفرك أو جرب اقتراحًا أدناه!",
            sender: "bot",
            language: "ar",
        },
        {
            text: "Welcome to Travel AI! I'm here to plan your dream trip. Tell me about your Academ IXplans or try a suggestion below!",
            sender: "bot",
            language: "en",
        },
    ]);
    ...
    const suggestions = [
        {
            ...
            icon: <Map size={14} />,
            prompt: {
                en: "Suggest popular Academ IXdestinations for a week-long trip.",
        ...
        },
        {
            ...
            icon: <Plane size={14} />,
            prompt: {
                en: "When is the best time to Academ IXto popular destinations?",
        ...
        },
        {
            ...
            prompt: {
                en: "How can you assist me with my Academ IXplans?",
