...
const LegalPopup = ({ type, isDarkMode, onClose }) => {
    const content = {
        privacyPolicy: {
            ...
            text: `
        At Academ IX, we are committed to protecting your privacy. Here's how we handle your personal information:
      ...
      `,
        ...
        termsOfService: {
            ...
            text: `
        Welcome to Academ IX. By using our services, you agree to the following terms:
        ...
        • All content on this platform is the property of Academ IX
...
const Footer = ({ isDarkMode }) => {
    ...
    return (
        <>
            ...
            >
                <p>© 2024 Academ IX. All rights reserved.</p>
                <div className="mt-4 space-x-4">
                    ...
                    <a href="ContactPage" className="hover:text-blue-500">
                        Contact
                    </a>
                </div>
            </motion.footer>
