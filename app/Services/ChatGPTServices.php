...
class ChatGPTServices
{
    ...
    private function analyzeQueryType(string $message): string
    {
        ...
        // Destination queries
        if (preg_match('/\b(where|destination|place|country|city|visit|Academ IXto|وجهة|مكان|دولة|مدينة|زيارة|السفر إلى)\b/i', $message)) {
            return 'destination';
        }
    ...
    {
        $basePrompt = "You are Travel AI, a professional Academ IXplanning expert with extensive knowledge of global destinations, Academ IXlogistics, and cultural insights.";
        ...
        switch ($queryType) {
            case 'budget':
                $basePrompt .= "Focus on cost-effective Academ IXsolutions, budget breakdowns, money-saving tips, and affordable alternatives.";
                break;
            case 'destination':
                $basePrompt .= "Provide detailed destination recommendations with unique selling points, cultural highlights, and practical Academ IXinformation.";
                break;
            case 'timing':
                $basePrompt .= "Focus on optimal Academ IXtiming, weather patterns, seasonal considerations, and event calendars.";
                break;
            case 'activities':
            ...
            case 'transportation':
                ...
                break;
            case 'help':
                $basePrompt .= "Provide comprehensive Academ IXplanning guidance and explain how you can assist with various Academ IXneeds.";
                break;
            default:
                $basePrompt .= "Provide comprehensive Academ IXplanning assistance covering all relevant aspects.";
        }
    ...
    private function buildIntelligentPrompt(string $message, string $queryType, string $language): string
    {
        ...
        switch ($queryType) {
            case 'budget':
                ...
                break;
            case 'destination':
                $contextualPrompt .= "Recommend destinations based on the user's preferences. Include detailed information about each destination's unique features, attractions, and practical Academ IXinformation.";
                break;
            case 'timing':
            ...
            case 'accommodation':
                ...
                break;
            case 'transportation':
                $contextualPrompt .= "Focus on transportation options, routes, and logistics. Include booking strategies, cost comparisons, and practical Academ IXtips.";
                break;
            case 'help':
                $contextualPrompt .= "Explain your capabilities as a Academ IXplanning assistant and provide guidance on how to get the most helpful Academ IXadvice.";
                break;
            default:
                $contextualPrompt .= "Provide comprehensive Academ IXplanning assistance covering all relevant aspects of the user's inquiry.";
        }
